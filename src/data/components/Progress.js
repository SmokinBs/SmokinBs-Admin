...
export default () => (
	<article>
		<Container className="px-0">
			...
			<Documentation
				...
				description={
					<p>
						To update the appearance of the <code>&#x3C;Progress&#x3E;</code> component you can use the following classes for the <code>variant</code> attribute. You can also add a label text using the <code>label="lorem ipsum"</code> attribute.
					</p>
				}
				scope={{ Progress }}
				imports={`import Progress from "src/components/Progress";`}
  ...
  <Progress variant="danger" label="Danger color" />
			...
			<Documentation
				...
				description={
					<p>
						You can also use one of the four available sizes for the <code>&#x3C;Progress&#x3E;</code> updating the <code>size="*"</code> attribute.
					</p>
				}
				scope={{ Progress }}
				imports={`import Progress from "src/components/Progress";`}
