...
export default () => {
			...
			<Container className="px-0">
				<Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
					<Col className="d-block mb-4 mb-md-0">
						...
						<p className="mb-0">Use popovers to indicate extra content for your users when clicking on an element.</p>
					</Col>
				</Row>
  ...
  <Button variant="secondary" size="sm" className="m-2">Popover on top</Button>
				...
				<Documentation
					...
					description={
						<p>
							The <code>&#x3C;Popover&#x3E;</code> can also be positioned accordingly, using the <code>placement="*"</code> attribute, where the value can be either <code>top</code>, <code>right</code>, <code>bottom</code> or <code>left</code>.
						</p>
					}
					scope={{ Button, Popover, OverlayTrigger }}
					imports={`import { Button, Popover, OverlayTrigger } from '@themesberg/react-bootstrap';`}
