				...
				<Container>
					<p className="text-center">
						<Card.Link as={Link} to={Routes.Dashboard.path} className="text-gray-700">
							<FontAwesomeIcon icon={faAngleLeft} className="me-2" width={20} height={20} /> Back to homepage
						</Card.Link>
					</p>
							...
							<div className="bg-white shadow-soft border border-light rounded p-4 p-lg-5 w-100 fmxw-500">
								...
								<Form className="mt-5">
									<Form.Group id="password" className="mb-4">
										...
										<InputGroup>
											<InputGroup.Text>
												<FontAwesomeIcon icon={faUnlockAlt} width={20} height={20} />
											</InputGroup.Text>
											<Form.Control required type={passwordInputType} placeholder="Password" />
											<InputGroup.Text onClick={togglePasswordVisibility}>
												<FontAwesomeIcon color={passwordIconColor} icon={faEye} width={20} height={20} />
											</InputGroup.Text>
										</InputGroup>
									</Form.Group>
