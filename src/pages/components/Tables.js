...
const ValueChange = ({ value, suffix }) => {
	...
	return value ? (
		<span className={valueTxtColor}>
			<FontAwesomeIcon icon={valueIcon} width={20} height={20} />
...
// 				<td>${returnValue}</td>
// 				<td>
// 					<FontAwesomeIcon icon={bounceIcon} className={`${bounceTxtColor} me-3`} width={20} height={20} />
// 					{Math.abs(bounceRate)}%
// 				</td>
// 			</tr>
// 		);
					...
					<Dropdown as={ButtonGroup}>
						<Dropdown.Toggle as={Button} split variant="link" className="text-dark m-0 p-0">
							<span className="icon icon-sm">
								<FontAwesomeIcon icon={faEllipsisH} className="icon-dark" width={20} height={20} />
							</span>
						</Dropdown.Toggle>
						<Dropdown.Menu>
							<Dropdown.Item>
								<FontAwesomeIcon icon={faEye} className="me-2" width={20} height={20} /> View Details
							</Dropdown.Item>
							<Dropdown.Item>
								<FontAwesomeIcon icon={faEdit} className="me-2" width={20} height={20} /> Edit
							</Dropdown.Item>
							<Dropdown.Item className="text-danger">
								<FontAwesomeIcon icon={faTrashAlt} className="me-2" width={20} height={20} /> Remove
							</Dropdown.Item>
						</Dropdown.Menu>
					</Dropdown>
				</td>
...
// 							Read More <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" width={20} height={20} />
// 						</Card.Link>
// 					</pre>
// 				</td>
// 			</tr>
