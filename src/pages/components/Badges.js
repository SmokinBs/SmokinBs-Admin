...
export default () => (
		...
		<Container className="px-0">
			<Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
				<Col className="d-block mb-4 mb-md-0">
					...
					<p className="mb-0">Use badges to add extra labeling to alongside titles or to categorize items.</p>
				</Col>
			</Row>
  ...
  <Badge bg="dark">Dark</Badge>
			...
			<Documentation
				...
				description={
					<p>
						To update the size of the <code>&#x3C;Badge&#x3E;</code> component you can use the size modified classes, such as <code>badge-md</code> or <code>badge-lg</code>.
					</p>
				}
				scope={{ Badge }}
				imports={`import { Badge } from '@themesberg/react-bootstrap';`}
  ...
  <Badge bg="success" className="badge-lg">Success</Badge>
			...
			<Documentation
				...
				description={
					<p>
						Set the <code>pill</code> on <code>true</code> property to make badges more rounded with a larger border radius.
					</p>
				}
				scope={{ Badge }}
				imports={`import { Badge } from '@themesberg/react-bootstrap';`}
  ...
  <Badge pill={true} bg="danger" className="me-1">Danger</Badge>
			...
			<Documentation
				...
				description={
					<p>
						You can also use the <code>&#x3C;Badge&#x3E;</code> component inside other components, such as buttons, alerts, simple paragraphs.
					</p>
				}
				scope={{ Button, Badge }}
