        ...
        <Nav.Link eventKey="messages" href="#" className="mb-sm-3 mb-md-0">
          Messages
			...
			<Documentation
				...
				description={<p>If you want to add other content to a navigation item, such as an icon, you can do that by </p>}
...
import { faComments, faSun, faUserCircle } from '@fortawesome/free-regular-svg-icons';`}
  ...
  <Col lg={6}>
    <Nav fill defaultActiveKey="home" variant="pills" className="flex-column flex-md-row">
      <Nav.Item>
        <Nav.Link eventKey="home" href="#" className="mb-sm-3 mb-md-0">
          <FontAwesomeIcon icon={faTachometerAlt} className="me-2" width={20} height={20} /> Home
            </Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link eventKey="profile" href="#" className="mb-sm-3 mb-md-0">
          <FontAwesomeIcon icon={faUserCircle} className="me-2" width={20} height={20} /> Profile
            </Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link eventKey="settings" href="#" className="mb-sm-3 mb-md-0">
          <FontAwesomeIcon icon={faSun} className="me-2" width={20} height={20} /> Settings
            </Nav.Link>
      </Nav.Item>
      <Nav.Item>
